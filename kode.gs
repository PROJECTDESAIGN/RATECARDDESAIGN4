...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & teks utama menggunakan warna Lilac/Purple (#8A65AA) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #8A65AA}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#8A65AA;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#8A65AA;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#8A65AA;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone Lavender Soft (#F8F5FA) */
    '.info-box{background:#F8F5FA;border:1px solid #E3D7ED;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Lilac (#8A65AA) */
    '.paket-box{background:#8A65AA;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan dengan nuansa lilac sangat muda */
    '.syarat-box{background:#FCFAFE;border:1px solid #EDE4F4;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa Lilac Light (#F3EDF7) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#F3EDF7;border:1px solid #D9C8E8;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#6A448A;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #E3D7ED;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
